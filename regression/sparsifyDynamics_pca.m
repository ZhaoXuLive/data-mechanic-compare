function [Xi, Xintercept, allCoeff, allNumComponents, Sigvars] = sparsifyDynamics_pca(Theta, dXdt)
...
allCoeff = zeros(5, size(Theta,2), size(Theta,2));
allNumComponents = zeros(5, 1);
...
for i = 1:5
    ...
    % 将测试数据投影到主成分空间，记录
    allCoeff(i, :, :) = coeff;
    allNumComponents(i) = numComponents;
