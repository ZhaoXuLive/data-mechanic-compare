...
% for i = 1:n
%     subplot(2,n/2,i)
%     plot(tx1, dx1(:,i),'k','Linewidth',[2]);
%     hold on;
%     plot(tx1, x1(:,i),'r--','Linewidth',[2])
%     legend('dx','x')
%     title('Detrivative of Ideal Data 1')
% end
% 
% figure,
% for i = 1:n
...
% for i = 1:n
%     subplot(2,n/2,i)
%     plot(tx2, dx2(:,i),'k','Linewidth',[2]);
%     hold on;
%     plot(tx2, x2(:,i),'r--','Linewidth',[2])
%     legend('dx','x')
%     title('Detrivative of Ideal Data 2')
% end
% 
% figure,
% for i = 1:n
...
% for i = 1:n
%     subplot(2,n/2,i)
%     plot(tx3, dx3(:,i),'k','Linewidth',[2]);
%     hold on;
%     plot(tx3, x3(:,i),'r--','Linewidth',[2])
%     legend('dx','x')
%     title('Detrivative of Ideal Data 3')
% end
% 
% figure,
% for i = 1:n
...
% for i = 1:n
%     subplot(2,n/2,i)
%     plot(tx4, dx4(:,i),'k','Linewidth',[2]);
%     hold on;
%     plot(tx4, x4(:,i),'r--','Linewidth',[2])
%     legend('dx','x')
%     title('Detrivative of Ideal Data 4')
% end
% 
% figure,
% for i = 1:n
...
% for i = 1:n
%     subplot(2,n/2,i)
%     plot(tx5, dx5(:,i),'k','Linewidth',[2]);
%     hold on;
%     plot(tx5, x5(:,i),'r--','Linewidth',[2])
%     legend('dx','x')
%     title('Detrivative of Ideal Data 5')
% end
% 
% figure,
% for i = 1:n
...
% for i = 1:n
%     subplot(2,n/2,i)
%     plot(tx6, dx6(:,i),'k','Linewidth',[2]);
%     hold on;
%     plot(tx6, x6(:,i),'r--','Linewidth',[2])
%     legend('dx','x')
%     title('Detrivative of Ideal Data 6')
% end
